...
object_building_tatooine_starport_tatooine_empty = object_building_tatooine_shared_starport_tatooine_empty:new {
	gameObjectType = 521,
...
ObjectTemplates:addTemplate(object_building_tatooine_starport_tatooine_empty, "object/building/tatooine/starport_tatooine_empty.iff")
