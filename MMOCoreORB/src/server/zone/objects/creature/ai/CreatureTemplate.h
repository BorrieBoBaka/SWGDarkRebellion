...
public:
	...
	inline int getRpStat(int index) {
		return rp_stats.get(index);
	}

	inline int getRpSkill(int index) {
		return rp_skills.get(index);
	}

	inline int getRpPool(int index) {
		return rp_pools.get(index);
	}
